...
num_iters_per_epoch = int(158081 // (num_gpus * samples_per_gpu) )
num_epochs = 12
...
# Data
dataset_type = 'WaymoDatasetOcc'
data_root = 'data/waymo/kitti_format/'
file_client_args = dict(backend='disk')
occupancy_path = 'data/waymo/gts/'
occupancy_path_trianing = 'data/waymo/gts/training'
occupancy_path_val = 'data/waymo/gts/validation'

pose_file = occupancy_path + 'cam_infos.pkl'
val_pose_file = occupancy_path + 'cam_infos_vali.pkl'
...
train_pipeline = [
    ...
    dict(type='LoadOccGTFromFileWaymo', ignore_nonvisible=True, fix_void=fix_void,  occupancy_path=occupancy_path_trianing,FREE_LABEL=FREE_LABEL,num_classes=num_cls,use_infov_mask=use_infov_mask,
...
test_data_config = dict(
    ...
    ann_file=occupancy_path + 'waymo_infos_val.pkl',
    pose_file=val_pose_file,
    occupancy_path=occupancy_path_val,
    split='training',)
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=occupancy_path + 'waymo_infos_train.pkl',
        ...
        pose_file=pose_file,
        split='training',
        occupancy_path=occupancy_path_trianing,
        box_type_3d='LiDAR'),
