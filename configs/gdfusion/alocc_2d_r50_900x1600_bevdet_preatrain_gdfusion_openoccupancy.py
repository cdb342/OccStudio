...
# ===> bus - IoU = 15.2033
# ===> car - IoU = 21.7334
# ===> construction_vehicle - IoU = 10.2826
# ===> motorcycle - IoU = 13.7858
# ===> pedestrian - IoU = 12.8823
# ===> traffic_cone - IoU = 11.4336
# ===> trailer - IoU = 8.1333
# ===> truck - IoU = 15.725
# ===> driveable_surface - IoU = 41.2916
# ===> other_flat - IoU = 27.206
# ===> sidewalk - IoU = 26.6358
# ===> terrain - IoU = 23.6661
# ===> manmade - IoU = 12.5975
# ===> vegetation - IoU = 17.351
# ===> free - IoU = 97.1242
# ===> mIoU of 6019 samples: 17.92
# ===> mIoU_D = 13.652
# ===> occupied - IoU = 28.617
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                with_label=False),
            dict(type='Collect3D', keys=['points', 'img_inputs',  'gt_occupancy', 'aux_cam_params','adj_aux_cam_params'])
            ]
        )
]
