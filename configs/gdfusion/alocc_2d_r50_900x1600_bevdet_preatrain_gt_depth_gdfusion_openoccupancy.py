...
# ===> bus - IoU = 21.7081
# ===> car - IoU = 28.2912
# ===> construction_vehicle - IoU = 14.9581
# ===> motorcycle - IoU = 24.1279
# ===> pedestrian - IoU = 26.8563
# ===> traffic_cone - IoU = 16.4754
# ===> trailer - IoU = 17.1106
# ===> truck - IoU = 23.0369
# ===> driveable_surface - IoU = 42.055
# ===> other_flat - IoU = 29.0582
# ===> sidewalk - IoU = 28.4476
# ===> terrain - IoU = 26.6583
# ===> manmade - IoU = 23.8999
# ===> vegetation - IoU = 26.815
# ===> free - IoU = 97.4327
# ===> mIoU of 6019 samples: 24.51
# ===> mIoU_D = 21.6488
# ===> occupied - IoU = 34.5569
...
gts_surroundocc=True
gts_openoccupancy=True
cal_metric_in_model=True
...
model = dict(
    ...
    gts_surroundocc=gts_surroundocc,
    dz=dz,
    cal_metric_in_model=cal_metric_in_model,
    img_backbone=dict(
...
train_pipeline = [
    ...
    dict(type='LoadOccupancy', ignore_nonvisible=use_camera_visible_mask, fix_void=fix_void, occupancy_path=occupancy_path,gts_openoccupancy=gts_openoccupancy,occ_size=occ_size),
...
test_pipeline = [
    dict(
        ...
        tta=False,
        transforms=[
            dict(type='PrepareImageInputs', data_config=data_config, sequential=True,geometry_his_fusion=geometry_his_fusion,gts_surroundocc=gts_surroundocc),
            dict(
                type='LoadAnnotationsBEVDepth',
                bda_aug_conf=bda_aug_conf,
                classes=class_names,
            ...
            dict(
                ...
                with_label=False),
            dict(type='Collect3D', keys=['points', 'img_inputs',  'gt_occupancy', 'gt_depth','aux_cam_params','adj_aux_cam_params'])
            ]
        )
]
