...
# +----------------------+----------+----------+----------+
# |        others        |  0.107   |  0.118   |  0.120   |
# |       barrier        |  0.425   |  0.476   |  0.495   |
# |       bicycle        |  0.250   |  0.283   |  0.292   |
# |         bus          |  0.512   |  0.616   |  0.673   |
# |         car          |  0.502   |  0.577   |  0.608   |
# | construction_vehicle |  0.218   |  0.321   |  0.362   |
# |      motorcycle      |  0.224   |  0.298   |  0.315   |
# |      pedestrian      |  0.320   |  0.374   |  0.392   |
# |     traffic_cone     |  0.304   |  0.334   |  0.343   |
# |       trailer        |  0.208   |  0.292   |  0.387   |
# |        truck         |  0.428   |  0.536   |  0.582   |
# |  driveable_surface   |  0.605   |  0.671   |  0.735   |
# |      other_flat      |  0.329   |  0.367   |  0.397   |
# |       sidewalk       |  0.291   |  0.343   |  0.387   |
# |       terrain        |  0.279   |  0.360   |  0.426   |
# |       manmade        |  0.355   |  0.450   |  0.504   |
# |      vegetation      |  0.253   |  0.374   |  0.461   |
# +----------------------+----------+----------+----------+
# |         MEAN         |  0.330   |  0.399   |  0.440   |
# +----------------------+----------+----------+----------+
# {'RayIoU': 0.3898118648551078, 'RayIoU@1': 0.3300250250580663, 'RayIoU@2': 0.3994459793213218, 'RayIoU@4': 0.43996459018593564}
...
train_pipeline = [
    ...
    dict(
        type='Collect3D', keys=['img_inputs',   'gt_occupancy', 'gt_depth'
                               ])
]
